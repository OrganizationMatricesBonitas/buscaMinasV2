...
//	UI frame;
	...
	public Botonera(int lado, ActionListener actionListener) {
//		controlador = new Controlador(lado);
		...
		generarBotones(actionListener);
//		renderTablero();
	}

	public Botonera(int lado, int minas, ActionListener actionListener) {
		inGame = false;
...
//		this.frame = frame;
	...
	private void generarBotones(ActionListener actionListener) {
